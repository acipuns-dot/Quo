...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* ── 9. Contact ── */}
      <section id="contact" className="quo-faq-section">
        <div className="max-w-xl mx-auto px-6 py-20">
          <div className="animate-slide-up text-center mb-12">
            <p className="quo-eyebrow-inv text-xs font-semibold uppercase tracking-widest mb-2">Contact</p>
            <h2 className="quo-heading-light text-3xl font-bold">Get in touch</h2>
          </div>
          <div className="space-y-3">
            <a
            ...
            >
              ...
              <div>
                <p className="quo-faq-q font-bold text-sm mb-0.5">Discord community</p>
                <p className="quo-faq-a text-sm">Join the community for help and updates</p>
              </div>
            </a>
          </div>
        </div>
