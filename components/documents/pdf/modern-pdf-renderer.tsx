              ...
              {page.showTotals && model.kind !== "receipt" ? (
                ...
                >
                  ...
                  >
                    ...
                    <span>{formatCurrency(model.totals.lineItemSubtotal, model.currency)}</span>
                  </div>
                  {model.totals.additionalFees.map((fee) => (
                    <div
                      key={fee.id}
                      style={{
                        display: "flex",
                    ...
                    >
                      ...
                      <span>{formatCurrency(fee.amount, model.currency)}</span>
                    </div>
                  ))}
                  {model.applyTax ? (
                    <div
